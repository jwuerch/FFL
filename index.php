                        ...
                        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							...
							<article id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?> role="article">
								...
								<header class="article-header">
                                    ...
                                    <div class="category"><?php printf( '<div class="entry-category category mobile-category">' . __('', 'bonestheme' ) . ' %1$s</div>' , get_the_category_list(', ') ); ?></div>
									<h2 class="h2 entry-title"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
									<div><span class="byline entry-meta vcard">
